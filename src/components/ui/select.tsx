  ...
  <SelectPrimitive.Portal>
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn('p-1', props.position === 'popper' && 'w-[var(--radix-select-trigger-width)]', props.position === 'popper' && 'min-w-[var(--radix-select-trigger-width)]')}
      >
        {children}
      </SelectPrimitive.Viewport>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-body-xs font-semibold text-muted-foreground', className)}
    {...props}
  />
));
