        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col md:flex-row justify-between items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-[10px] text-slate-400 block font-semibold">SaaS Unified Food Commerce â€¢ Bozeman, MT</span>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
          <div>
            ...
            <p className="text-[11px] leading-relaxed text-slate-400">
              Complete rÃºstico-elegante SaaS for mountain food business across the West. Proudly supporting businesses on Flathead Lake, Big Sky, and Glacier Valley grids.
            </p>
          </div>
          <div>
            ...
            <ul className="text-[11px] space-y-1 text-slate-400 list-none font-medium">
              <li>âœ“ Fully compliant with PCI-DSS 4.0 data security standards</li>
              <li>âœ“ Automated calculation of Montana local Resort Taxes</li>
              <li>âœ“ Multi-outlet compatibility & cloud ledger synchronization</li>
            </ul>
          </div>
          <div>
    ...
    <div className="bg-white rounded-2xl border border-slate-150 p-6 shadow-sm space-y-6 text-slate-800 max-w-4xl mx-auto anim-fade-in text-xs sm:text-sm">
      <div className="border-b border-slate-100 pb-4">
        <h3 className="font-black text-xl text-slate-900 tracking-tight flex items-center gap-2">
          <BookOpen className="h-6 w-6 text-amber-800" /> Guia de ProduÃ§Ã£o & Deploy
        </h3>
        <p className="text-xs text-slate-500 mt-1">Siga este roteiro passo a passo para colocar o TableFlow MT em produÃ§Ã£o</p>
      </div>

      <div className="space-y-4">
        <div className="space-y-1.5">
          <h4 className="font-bold text-slate-800">1. ConfiguraÃ§Ã£o do Banco de Dados (Firebase Cloud Firestore)</h4>
          <p className="text-slate-600 leading-relaxed text-xs">
            Atualmente, o aplicativo estÃ¡ conectado a um banco de dados **Firestore** provisionado automaticamente usando o ID `gen-lang-client-0298850526`. As regras de seguranÃ§a estÃ£o prontas em `firestore.rules`. Para usar sua prÃ³pria instÃ¢ncia no console do Firebase:
          </p>
...
firebase init firestore`}
          ...
          <p className="text-slate-600 leading-relaxed text-xs">
            Em seguida, atualize o arquivo `/firebase-applet-config.json` com suas credenciais de produÃ§Ã£o do Firebase.
          </p>
        </div>

        <div className="space-y-1.5 pt-2 border-t border-slate-100">
          <h4 className="font-bold text-slate-800">2. ExecuÃ§Ã£o Local & InstalaÃ§Ã£o de DependÃªncias</h4>
          <p className="text-slate-650 leading-relaxed text-xs">
            Clone o cÃ³digo e execute os comandos abaixo para inicializar o ambiente de desenvolvimento local usando Vite:
          </p>
...
npm run dev`}
        ...
        <div className="space-y-1.5 pt-2 border-t border-slate-100">
          <h4 className="font-bold text-slate-800">3. Transmitir ConfiguraÃ§Ãµes de SeguranÃ§a do Firestore</h4>
          <p className="text-slate-650 leading-relaxed text-xs">
            As seguintes regras de seguranÃ§a devem ser definidas no seu painel para garantir que apenas pessoas autorizadas leiam ou escrevam nos dados da sua empresa:
          </p>
...
service cloud.firestore {
  match /databases/{database}/documents {
    match /{document=**} {
      allow read, write: if true; // Em produÃ§Ã£o troque por: request.auth != null
    }
  }
}`}
          </pre>
        ...
        <div className="space-y-1.5 pt-2 border-t border-slate-100">
          ...
          <p className="text-slate-655 leading-relaxed text-xs">
            Para gerar a versÃ£o otimizada de produÃ§Ã£o pronta para o Google Cloud Run ou Firebase Hosting, utilize:
          </p>
          <pre className="bg-slate-900 text-amber-400 p-2.5 rounded-lg text-xs font-mono overflow-x-auto">
{`# Criar compilaÃ§Ã£o de produÃ§Ã£o
npm run build
      ...
      <div className="bg-amber-50 rounded-xl p-3 border border-amber-100/80 text-xs text-amber-900 flex items-start gap-2">
        ...
        <div>
          ...
          <p className="text-slate-700 leading-normal mt-0.5">
            Montana nÃ£o possui imposto sobre vendas estadual basilar. No entanto, o sistema TableFlow calcula automaticamente os impostos de recurso (como a taxa municipal obrigatÃ³ria de 4% de Big Sky e 3% de Whitefish), permitindo que vocÃª preste contas Ã s entidades fiscais sem complicaÃ§Ãµes jurÃ­dicas.
          </p>
        </div>
      </div>
    </div>
